...
{
	/*
	public static SearchAlgorithm makeSearch(String searchName, Maze maze, Point start, Point goal)
	{
		SearchAlgorithm search = null;
		
		if(searchName.equals("DFS")) search = new DFS(maze, start, goal);
		else if (searchName.equals("BFS")) search = new BFS(maze, start, goal);
		else if (searchName.equals("RandomWalk")) search = new RandomWalk(maze, start, goal);
		else if (searchName.equals("Greedy")) search = new Greedy(maze, start, goal);
		else if (searchName.equals("Magic")) search = new Magic(maze, start, goal);
